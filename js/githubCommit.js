        ...
        return fetch(`https://api.github.com/repos/${username}/${latestRepo.name}/commits`)
          ...
          .then(commits => {
            if (commits && commits.length > 0) {
              ...
              document.getElementById('lastCommitDate').innerHTML = `<strong><a href="https://github.com/${username}/${latestRepo.name}" target="_blank" style="color: red; text-decoration: underline;">${latestRepo.name}</a></strong>: ${timeText}`;
            } else {
